...
LP_A = [] # New list for low pass filter
widthA = 100

moving_avg(widthA, LP_A, yA)
Fs_Afilt = Fs_A
...
LP_B = [] # New list for low pass filter
widthB = 100

moving_avg(widthB, LP_B, yB)
Fs_Bfilt = Fs_B
...
LP_C = [] # New list for low pass filter
widthC = 100

moving_avg(widthC, LP_C, yC)
Fs_Cfilt = Fs_C
...
LP_D = [] # New list for low pass filter
widthD = 100

moving_avg(widthD, LP_D, yD)
Fs_Dfilt = Fs_D
